<template>
    <div class="flex justify-center items-center min-h-screen bg-green-200">
      <div class="container mx-auto p-8 bg-white rounded-lg shadow-lg border border-black-300 bg-blue">
        <h1 class="text-5xl text-center text-black-800 mb-10">Expense Track</h1>
        <div class="flex">
                <div class="flex-1 mr-8 max-w-lg">
                    ...
                    <select v-model="newExpense.category" class="input-field">
                        <option value="" disabled selected>Category Expense</option>
          ...
          <div class="flex-1 relative"> 
            <div class="expenses-table-container border border-black-300">
              <table class="w-full">
                <thead>
                  <tr>
                    <th class="border border-black-300 px-4 py-2">Date & Time</th>
                    <th class="border border-black-300 px-4 py-2">Item</th>
                    <th class="border border-black-300 px-4 py-2">Category</th>
                ...
                <tbody>
                  <tr v-for="(expense, index) in expenses" :key="index">
                    <td class="border border-black-300 px-4 py-2">{{ expense.dateTime }}</td>
                    <td class="border border-black-300 px-4 py-2">{{ expense.item }}</td>
                    <td class="border border-black-300 px-4 py-2">{{ expense.category }}</td>
                    <td class="border border-black-300 px-4 py-2">{{ expense.amount }}</td>
